...
if __name__=="__main__":
    ...
    #train_TCN(device, "training data/20220915203948_8CCE4E9A045C_mp_skeleton.csv", 25)
    train_LSTM(device, "training data/20220915203948_8CCE4E9A045C_mp_skeleton.csv", 25)